...
def transaction2(productId, sellerId, productName, Description, Quantity, Price):
...
transaction2(45, "S1", "iphone", "lightweight", 4, 800)
transaction2(46, "S1", "macbook", "classy", 2, 1000)